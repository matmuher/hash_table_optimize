...
uint32_t pjw_hash_brls (const char* key, uint32_t len);
extern "C"  uint32_t A_pjw_hash (const char* str)  __attribute__ ((naked));
extern "C"  uint32_t A_rol_hash (const char* str)  __attribute__ ((naked));
